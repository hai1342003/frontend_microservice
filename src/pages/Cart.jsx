      ...
      <div>
        {
          ...
          cartData.map((item,index) => {
            ...
            return (
              <div key={index} className='py-4 border-t border-b text-gray-700 grid grid-cols-1 md:grid-cols-3'>
                <div className=' flex items-start gap-6'>
                  <img className='w-16 sm:w-20' src={`/images/${productData.image1}`} alt="" />
                  <div>
